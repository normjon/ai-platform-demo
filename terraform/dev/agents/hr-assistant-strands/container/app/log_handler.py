...
sidecar silently drops stdout events (confirmed on the orchestrator runtime
during 2026-04 debugging); this handler provides an independent diagnostic
channel for all application logging by calling PutLogEvents directly.
