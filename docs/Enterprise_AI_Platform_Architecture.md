...
| **X-Ray Tracing**           | Distributed traces across Lambda, Step Functions, and API Gateway invocations. Latency breakdown per service component for performance investigation.                                                        |
